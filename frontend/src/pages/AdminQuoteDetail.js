                        ...
                        <div>
                            ...
                            <div className="mt-3 flex items-center gap-3">
                                <div className="bg-white/20 backdrop-blur px-4 py-2 rounded-lg border border-white/30">
                                    <p className="text-white/70 text-xs uppercase tracking-wide">Tracking ID</p>
                                    <p className="text-white font-mono font-bold text-lg">{quote.quoteId}</p>
                                </div>
                                <button
                                    onClick={() => {
                    ...
                    <div className="lg:col-span-2">
                        ...
                        {saveMessage && (
                            <motion.div
                                ...
                                className={`mb-4 p-4 rounded-lg flex items-center gap-2 ${saveMessage.type === "success"
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 hover:bg-blue-100 hover:border-blue-300 transition-colors duration-200 cursor-pointer group">
                                    ...
                                    {quote.fromAddress && (
                                        <p className="text-sm text-gray-600 group-hover:text-white">{quote.fromAddress}</p>
                                    )}
                                    {quote.fromPincode && (
                                ...
                                <div className="bg-green-50 p-4 rounded-lg border border-green-200 hover:bg-green-100 hover:border-green-300 transition-colors duration-200 cursor-pointer group">
                                    ...
                                    {quote.toAddress && (
                                        <p className="text-sm text-gray-600 group-hover:text-white">{quote.toAddress}</p>
                                    )}
                                    {quote.toPincode && (
                                        <p className="text-sm text-gray-600 group-hover:text-white">
                        ...
                        >
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center gap-3 p-3 bg-gray-50 rounded cursor-pointer hover:bg-gray-100">
                                    <input type="checkbox" checked={quote.packingRequired} disabled className="w-5 h-5" />
                                    <span className="font-medium text-gray-700">
                                        Packing Required
                                    </span>
                                </label>
                                <label className="flex items-center gap-3 p-3 bg-gray-50 rounded cursor-pointer hover:bg-gray-100">
                                    <input type="checkbox" checked={quote.unpackingRequired} disabled className="w-5 h-5" />
                                    <span className="font-medium text-gray-700">
                                        Unpacking Required
                                    </span>
                                </label>
                                <label className="flex items-center gap-3 p-3 bg-gray-50 rounded cursor-pointer hover:bg-gray-100">
                                    <input type="checkbox" checked={quote.storageRequired} disabled className="w-5 h-5" />
                                    <span className="font-medium text-gray-700">
                                        Storage Required
                                    </span>
                                </label>
                                <label className="flex items-center gap-3 p-3 bg-gray-50 rounded cursor-pointer hover:bg-gray-100">
                                    <input type="checkbox" checked={quote.insuranceRequired} disabled className="w-5 h-5" />
                                    <span className="font-medium text-gray-700">
                                        Insurance Required
                                    </span>
                                </label>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        {isEditing ? (
                                            ...
                                            <p className="text-gray-800 font-semibold">
                                                {quote.estimatedCost ? `₹${quote.estimatedCost.toLocaleString("en-IN")}` : "Not set"}
                                            </p>
                                        )}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        {isEditing ? (
                                            ...
                                            <p className="text-gray-800 font-semibold">
                                                {quote.finalCost ? `₹${quote.finalCost.toLocaleString("en-IN")}` : "Not set"}
                                            </p>
                                        )}
                                    </div>
                                </div>
                            ...
                            <div className="space-y-3">
                                ...
                                {quote.paymentStatus && (
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span
                                            className={`px-2 py-1 rounded text-xs font-semibold ${quote.paymentStatus === "completed"
                            ...
                            >
                                ...
                                <div className="space-y-3">
                                    ...
                                    <p className="text-xs text-gray-500 mt-2">
                                        On {new Date(feedback.createdAt).toLocaleDateString("en-IN")}
                                    </p>
                                </div>
                            </motion.div>
                        )}
